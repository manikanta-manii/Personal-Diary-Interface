 ...
 public class Diary extends JFrame implements ActionListener {
    ...
    final static String LOOKANDFEEL = null;
 	...
 	public void actionPerformed(ActionEvent e) {
 		if (e.getSource() == nu) {
 			int nuask = JOptionPane.showConfirmDialog(Diary.this,"Are you sure? This will make a erease any unsaved documents!");
 			if (nuask == JOptionPane.YES_OPTION) {
 				dat.setText("");
 			}
 		}
 		if (e.getSource() == open) {
 			int returnVal = fc.showOpenDialog(Diary.this);
 		...
 		if (e.getSource() == saveas) {
 			int returnVal = fc.showSaveDialog(Diary.this);
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                try {
                    File file = fc.getSelectedFile();
 		...
 		if (e.getSource() == exit) {
 			int aske = JOptionPane.showConfirmDialog(Diary.this,"Are you sure you want to exit " +getTitle() + " ?");
 		...
 		if (e.getSource() == clear) {
 			int cask = JOptionPane.showConfirmDialog(Diary.this,"Are you sure you want to clear the document?");

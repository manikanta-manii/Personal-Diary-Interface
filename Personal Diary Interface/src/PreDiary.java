...
public class PreDiary extends JFrame implements ActionListener{
    ...
    final static String LOOKANDFEEL = null;
	 ...
	 PreDiary()
	 {
		 	...
		 	public void actionPerformed(ActionEvent e) {
		 		if (e.getSource() == nu) {
		 			int nuask = JOptionPane.showConfirmDialog(PreDiary.this,"Are you sure? This will make a erease any unsaved documents!");
		 			if (nuask == JOptionPane.YES_OPTION) {
		 				dat.setText("");
		 			}
		 		}
		 		if (e.getSource() == open) {
		 			int returnVal = fc.showOpenDialog(PreDiary.this);
		 		...
		 		if (e.getSource() == saveas) {
		 			int returnVal = fc.showSaveDialog(PreDiary.this);
		            if (returnVal == JFileChooser.APPROVE_OPTION) {
		                try {
		                    File file = fc.getSelectedFile();
		 		...
		 		if (e.getSource() == exit) {
		 			int aske = JOptionPane.showConfirmDialog(PreDiary.this,"Are you sure you want to exit " +getTitle() + " ?");
		 		...
		 		if (e.getSource() == clear) {
		 			int cask = JOptionPane.showConfirmDialog(PreDiary.this,"Are you sure you want to clear the document?");
		 		...
		 		if (e.getSource() == about) {
		 			JOptionPane.showMessageDialog(null, "CREATED BY -- MANIKANTA P\n1NH20CS125\nContact-9019785436\nEMAIL--karna8722@gmailcom", "", JOptionPane.INFORMATION_MESSAGE);
		 		}
		 		if (e.getSource() == bb) {

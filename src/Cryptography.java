...
int wdth,hight;
    ...
    public Cryptography() {
		...
		buttonPanel1.setBorder(BorderFactory.createEmptyBorder());
		buttonPanel2.setBorder(BorderFactory.createEmptyBorder());
